...
Home: https://newville.github.io/wxmplot
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/wxmplot-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/wxmplot-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `wxmplot` available on your platform:
...
```
pixi search wxmplot --channel conda-forge
```
